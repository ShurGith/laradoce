...
class AdminPanelProvider extends PanelProvider
{
    ...
    public function panel(Panel $panel): Panel
    {
        FilamentView::registerRenderHook(
            ...
            fn() => '<a  class="border font-semibold border rounded-lg px-3 py-2 text-sm" href=\' /\'>Home</a>' . ((auth()->user()->isAdmin()) ? '<a  class="border font-semibold border rounded-lg px-3 py-2 text-sm" href=\' /admin\'>DashBoard</a>' : ''),
        );
        return $panel
            ->default()
            ->id('admin')
