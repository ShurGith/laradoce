        ...
        <div class="lg:grid lg:grid-cols-2 lg:items-start lg:gap-x-8">
            ...
            <div class="mt-10 flex flex-col justify-center items-center gap-y-4 px-4 sm:mt-16 sm:px-0 lg:mt-0">
                ...
                <div class="mt-6">
                    ...
                    @if($product->oferta)
                        <h5
                            class="max-w-fit mt-3 inline-flex justify-center items-center gap-x-1.5 rounded-md px-2 py-1 text-sm font-medium text-white bg-green-500 border border-green-700">
