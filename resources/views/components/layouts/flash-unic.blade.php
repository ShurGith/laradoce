<div class="fav-show-add  w-full max-w-[600px] bg-green-50 p-4 flex items-center justify-evenly">
...
<div class="fav-show-remove hidden rounded-md w-full max-w-[600px] bg-red-50 p-4 flex items-center justify-evenly">
  <div class="flex items-center gap-2 ">
